...
def changeBG(widget):
    ...
    widget.after(100, lambda: changeBG(widget))
def start_timer():
...
titleframe.grid()
titleLabel=Label(titleframe,text='TYPING SPEED TESTER',font=('algerian',28,'bold'),bg='blue',fg='white'
                 ,width=38,bd=10)
titleLabel.grid(pady=5)
paragraph_frame=Frame(mainframe)
paragraph_frame.grid(row=1,column=0)
paragraph_list=[' Python is an interpreted, object-oriented, high-level programming language with dynamic semantics. Its high-level built in data structures, combined with dynamic typing and dynamic binding, make it very attractive for Rapid Application Development, as well as for use as a scripting or glue language to connect existing components together.',
...
totalwords_label=Label(frame_output,text='Total Words',font=('Tahoma',12,'bold'),fg='blue')
...
wrongwords_label=Label(frame_output,text='Wrong Words',font=('Tahoma',12,'bold'),fg='blue')
...
accuracy_label=Label(frame_output,text='Accuracy',font=('Tahoma',12,'bold'),fg='blue')
